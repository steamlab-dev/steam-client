...
export type EProfileCustomizationStyle =
  (typeof EProfileCustomizationStyle)[keyof typeof EProfileCustomizationStyle];
...
export type EAgreementType = (typeof EAgreementType)[keyof typeof EAgreementType];
...
export namespace CPlayer_GetRecentPlaytimeSessionsForChild_Response {
...
export namespace CPlayer_GetPlayerLinkDetails_Response {
  export type PlayerLinkDetails = Record<string, never>;
...
export namespace CPlayer_GetOwnedGames_Response {
...
export interface ProfileItem {
  ...
  profile_colors?: ProfileItem.ProfileColor[];
  tiled?: boolean;
}
...
export namespace CPlayer_GetEmoticonList_Response {
...
export namespace CPlayer_GetCommunityBadgeProgress_Response {
...
export namespace CPlayer_GetTopAchievementsForGames_Response {
  ...
  export interface Game {
    ...
    achievements?: CPlayer_GetTopAchievementsForGames_Response.Achievement[];
  }
}
...
export interface CPlayer_GetAchievementsProgress_Response {
  achievement_progress?: CPlayer_GetAchievementsProgress_Response.AchievementProgress[];
}

export namespace CPlayer_GetAchievementsProgress_Response {
...
export namespace CPlayer_GetGameAchievements_Response {
  export interface Achievement {
...
export interface CPlayer_GetProfileCustomization_Response {
  ...
  purchased_customizations?: CPlayer_GetProfileCustomization_Response.PurchasedCustomization[];
...
export interface CPlayer_GetPurchasedProfileCustomizations_Response {
  purchased_customizations?: CPlayer_GetPurchasedProfileCustomizations_Response.PurchasedCustomization[];
}
...
export interface CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response {
  purchased_customizations?: CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.PurchasedCustomization[];
  upgraded_customizations?: CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.UpgradedCustomization[];
}

export namespace CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response {
  export interface PurchasedCustomization {
    customization_type?: EProfileCustomizationType;
    count?: number;
  }
...
export interface CPlayer_RecordDisconnectedPlaytime_Request {
  play_sessions?: CPlayer_RecordDisconnectedPlaytime_Request.PlayHistory[];
}

export namespace CPlayer_RecordDisconnectedPlaytime_Request {
