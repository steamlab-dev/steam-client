 ...
 */
import type { EGamescopeBlurMode } from "./enums";
import type { WebUINoResponse } from "./webuimessages_base";

export const EDisplayPowerState = {
  k_EDisplayPowerState_Invalid: 0,
  k_EDisplayPowerState_Off: 1,
  k_EDisplayPowerState_On: 2,
} as const;

export type EDisplayPowerState = (typeof EDisplayPowerState)[keyof typeof EDisplayPowerState];
...
export interface CMsgDisplayInfo {
  ...
  display_state?: EDisplayPowerState;
}
...
export abstract class GamescopeService {
  ...
  abstract NotifyStateChanged(
    request: CGamescope_StateChanged_Notification,
