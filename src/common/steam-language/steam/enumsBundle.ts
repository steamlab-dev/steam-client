...
export const steamEnums = {
  ...
  EHardwareCompatibilityFeedbackDetails: EHardwareCompatibilityFeedbackDetails,
  ...
  EPressOutletMemberPendingState: EPressOutletMemberPendingState,
  ...
  EStreamHostDisplaySetting: EStreamHostDisplaySetting,
